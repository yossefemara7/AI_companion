# Implementation inspired by/taken from: https://github.com/mallorbc/whisper_mic
# 
# This is a modified version of the WhisperMic logic to fit the needs of our project.
#
# It really just removes keyboard dictation, because Xorg is really annoying to work with
# when it comes to keyboard input. This is a workaround to that problem.
